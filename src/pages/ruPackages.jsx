          ...
          className="h-full rounded-[10px] mt-[69px] relative px-[13px]">
            <div className='relative'>
                ...
                <div className='flex gap-[17px] -top-7 relative z-10 w-full'>
                    <button className='bg-purple text-white text-xs w-full h-[55px] justify-center rounded-[5px] flex items-center relative' onClick={()=>router.push('/ruPublics')}>Выберите из списка 
