...
import soon from "../images/banners/soon.png";
import soonM from "../images/banners/soonM.png";
...
export default function Home() {
  return (
    <div>
      <Image className="hidden lg:block" fill src={soon} alt="banner"/>
      <Image className="block md:hidden" fill src={soonM} alt="banner"/>
    </div>
      // <Layout>
