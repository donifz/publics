  ...
  return (
    <Layout>
      ...
      <div className="pt-[63px] md:w-[480px] mx-auto relative">
        <h1 className="font-extrabold text-white  text-xl text-center mb-[39px]">
          Пакеты <br /> инстаграм
        </h1>
            ...
            <div className="flex flex-col items-center justify-center">
              <div className="flex gap-[57px]">
                <div className="w-[123px] h-[60px] pt-3 bg-[#D9D9D9] rounded-[5px] relative text-center flex justify-center">
                  <p className="w-[81px] h-[19px] border-[#D9D9D9] border rounded-[5px] absolute -top-2 bg-[#1F171C] text-white text-[12px] font-medium text-center flex items-center justify-center">
                    Охват
                  </p>
