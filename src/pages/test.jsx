    ...
    <Layout>
          ...
          className="h-[540px] rounded-[10px] mt-[55px] relative px-[32px] ">
            ...
            <menu className="w-full flex flex-col gap-5">
            {
              menu.map(item=>{
                if(item.status === 'soon'){
                  return (<li  className="w-full h-[62px] border-[0.5px] border-white rounded-[5px] flex pl-[32px] " key={item.id}>
                ...
                return (
                    <li className="w-full h-[62px] border-[0.5px] border-white rounded-[5px] flex pl-[32px] " key={item.id}>
